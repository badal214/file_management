...
if (isset($_POST['submit'])) {
	...
	echo "<script>console.log('".$userr_idd."')</script>";
	...
	$query="INSERT INTO `also_included` (`include_name`,`file_name`,`date`,`time`,`user_id`) VALUES ('$name','$fileName','$date','$time','$userr_idd')";
